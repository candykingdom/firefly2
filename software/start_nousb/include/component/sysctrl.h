...
#define   SYSCTRL_DPLLCTRLB_LTIME_NONE_Val _U(0x0)   /**< \brief (SYSCTRL_DPLLCTRLB) Default	No time-out */
#define   SYSCTRL_DPLLCTRLB_LTIME_8MS_Val _U(0x4)   /**< \brief (SYSCTRL_DPLLCTRLB) 8MS	Time-out if no lock within 8 ms */
#define   SYSCTRL_DPLLCTRLB_LTIME_9MS_Val _U(0x5)   /**< \brief (SYSCTRL_DPLLCTRLB) 9MS	Time-out if no lock within 9 ms */
#define   SYSCTRL_DPLLCTRLB_LTIME_10MS_Val _U(0x6)   /**< \brief (SYSCTRL_DPLLCTRLB) 10MS	Time-out if no lock within 10 ms */
#define   SYSCTRL_DPLLCTRLB_LTIME_11MS_Val _U(0x7)   /**< \brief (SYSCTRL_DPLLCTRLB) 11MS	Time-out if no lock within 11 ms */
