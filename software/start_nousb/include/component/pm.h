...
#define PM_CTRL_CFDEN               (_U(0x1) << PM_CTRL_CFDEN_Pos)
#define PM_CTRL_BKUPCLK_Pos         4            /**< \brief (PM_CTRL) Backup Clock Select */
#define PM_CTRL_BKUPCLK             (_U(0x1) << PM_CTRL_BKUPCLK_Pos)
#define PM_CTRL_MASK                _U(0x14)     /**< \brief (PM_CTRL) MASK Register */
...
#define PM_APBCMASK_RESETVALUE      _U(0x00000100) /**< \brief (PM_APBCMASK reset_value) APBC Mask */
...
#define PM_APBCMASK_MASK            _U(0x00000FFF) /**< \brief (PM_APBCMASK) MASK Register */
...
#define PM_INTENCLR_CFD             (_U(0x1) << PM_INTENCLR_CFD_Pos)
#define PM_INTENCLR_MASK            _U(0x03)     /**< \brief (PM_INTENCLR) MASK Register */
...
#define PM_INTENSET_CFD             (_U(0x1) << PM_INTENSET_CFD_Pos)
#define PM_INTENSET_MASK            _U(0x03)     /**< \brief (PM_INTENSET) MASK Register */
...
#define PM_INTFLAG_CFD              (_U(0x1) << PM_INTFLAG_CFD_Pos)
#define PM_INTFLAG_MASK             _U(0x03)     /**< \brief (PM_INTFLAG) MASK Register */
