...
#define EVSYS_CHANNEL_CHANNEL_Msk   (_U(0x7) << EVSYS_CHANNEL_CHANNEL_Pos)
...
#define EVSYS_CHANNEL_EVGEN_Msk     (_U(0x3F) << EVSYS_CHANNEL_EVGEN_Pos)
...
#define EVSYS_CHANNEL_MASK          _U(0x0F3F0107) /**< \brief (EVSYS_CHANNEL) MASK Register */
...
#define EVSYS_USER_CHANNEL_Msk      (_U(0xF) << EVSYS_USER_CHANNEL_Pos)
...
#define EVSYS_USER_MASK             _U(0x0F1F)   /**< \brief (EVSYS_USER) MASK Register */
...
#define EVSYS_CHSTATUS_RESETVALUE   _U(0x0000003F) /**< \brief (EVSYS_CHSTATUS reset_value) Channel Status */
...
#define EVSYS_CHSTATUS_USRRDY_Msk   (_U(0x3F) << EVSYS_CHSTATUS_USRRDY_Pos)
...
#define EVSYS_CHSTATUS_CHBUSY_Msk   (_U(0x3F) << EVSYS_CHSTATUS_CHBUSY_Pos)
#define EVSYS_CHSTATUS_CHBUSY(value) (EVSYS_CHSTATUS_CHBUSY_Msk & ((value) << EVSYS_CHSTATUS_CHBUSY_Pos))
#define EVSYS_CHSTATUS_MASK         _U(0x00003F3F) /**< \brief (EVSYS_CHSTATUS) MASK Register */
...
#define EVSYS_INTENCLR_OVR_Msk      (_U(0x3F) << EVSYS_INTENCLR_OVR_Pos)
...
#define EVSYS_INTENCLR_EVD_Msk      (_U(0x3F) << EVSYS_INTENCLR_EVD_Pos)
#define EVSYS_INTENCLR_EVD(value)   (EVSYS_INTENCLR_EVD_Msk & ((value) << EVSYS_INTENCLR_EVD_Pos))
#define EVSYS_INTENCLR_MASK         _U(0x00003F3F) /**< \brief (EVSYS_INTENCLR) MASK Register */
...
#define EVSYS_INTENSET_OVR_Msk      (_U(0x3F) << EVSYS_INTENSET_OVR_Pos)
...
#define EVSYS_INTENSET_EVD_Msk      (_U(0x3F) << EVSYS_INTENSET_EVD_Pos)
#define EVSYS_INTENSET_EVD(value)   (EVSYS_INTENSET_EVD_Msk & ((value) << EVSYS_INTENSET_EVD_Pos))
#define EVSYS_INTENSET_MASK         _U(0x00003F3F) /**< \brief (EVSYS_INTENSET) MASK Register */
...
#define EVSYS_INTFLAG_OVR_Msk       (_U(0x3F) << EVSYS_INTFLAG_OVR_Pos)
...
#define EVSYS_INTFLAG_EVD_Msk       (_U(0x3F) << EVSYS_INTFLAG_EVD_Pos)
#define EVSYS_INTFLAG_EVD(value)    (EVSYS_INTFLAG_EVD_Msk & ((value) << EVSYS_INTFLAG_EVD_Pos))
#define EVSYS_INTFLAG_MASK          _U(0x00003F3F) /**< \brief (EVSYS_INTFLAG) MASK Register */
