...
#define   GCLK_CLKCTRL_ID_SERCOMX_SLOW_Val _U(0xD)   /**< \brief (GCLK_CLKCTRL) SERCOMX_SLOW */
#define   GCLK_CLKCTRL_ID_SERCOM0_CORE_Val _U(0xE)   /**< \brief (GCLK_CLKCTRL) SERCOM0_CORE */
#define   GCLK_CLKCTRL_ID_SERCOM1_CORE_Val _U(0xF)   /**< \brief (GCLK_CLKCTRL) SERCOM1_CORE */
#define   GCLK_CLKCTRL_ID_SERCOM2_CORE_Val _U(0x10)   /**< \brief (GCLK_CLKCTRL) SERCOM2_CORE */
#define   GCLK_CLKCTRL_ID_TCC0_Val        _U(0x11)   /**< \brief (GCLK_CLKCTRL) TCC0 */
#define   GCLK_CLKCTRL_ID_TC1_TC2_Val     _U(0x12)   /**< \brief (GCLK_CLKCTRL) TC1_TC2 */
#define   GCLK_CLKCTRL_ID_ADC_Val         _U(0x13)   /**< \brief (GCLK_CLKCTRL) ADC */
#define   GCLK_CLKCTRL_ID_AC_DIG_Val      _U(0x14)   /**< \brief (GCLK_CLKCTRL) AC_DIG */
#define   GCLK_CLKCTRL_ID_AC_ANA_Val      _U(0x15)   /**< \brief (GCLK_CLKCTRL) AC_ANA */
#define   GCLK_CLKCTRL_ID_DAC_Val         _U(0x16)   /**< \brief (GCLK_CLKCTRL) DAC */
#define   GCLK_CLKCTRL_ID_PTC_Val         _U(0x17)   /**< \brief (GCLK_CLKCTRL) PTC */
