...
#define   TCC_FCTRLA_BLANK_START_Val      _U(0x0)   /**< \brief (TCC_FCTRLA) Blanking applied from start of ramp */
...
#define   TCC_FCTRLB_BLANK_START_Val      _U(0x0)   /**< \brief (TCC_FCTRLB) Blanking applied from start of ramp */
