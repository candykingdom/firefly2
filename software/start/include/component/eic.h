...
#define EIC_EVCTRL_EXTINTEO_Msk     (_U(0xFF) << EIC_EVCTRL_EXTINTEO_Pos)
#define EIC_EVCTRL_EXTINTEO(value)  (EIC_EVCTRL_EXTINTEO_Msk & ((value) << EIC_EVCTRL_EXTINTEO_Pos))
#define EIC_EVCTRL_MASK             _U(0x000000FF) /**< \brief (EIC_EVCTRL) MASK Register */
...
#define EIC_INTENCLR_EXTINT_Msk     (_U(0xFF) << EIC_INTENCLR_EXTINT_Pos)
#define EIC_INTENCLR_EXTINT(value)  (EIC_INTENCLR_EXTINT_Msk & ((value) << EIC_INTENCLR_EXTINT_Pos))
#define EIC_INTENCLR_MASK           _U(0x000000FF) /**< \brief (EIC_INTENCLR) MASK Register */
...
#define EIC_INTENSET_EXTINT_Msk     (_U(0xFF) << EIC_INTENSET_EXTINT_Pos)
#define EIC_INTENSET_EXTINT(value)  (EIC_INTENSET_EXTINT_Msk & ((value) << EIC_INTENSET_EXTINT_Pos))
#define EIC_INTENSET_MASK           _U(0x000000FF) /**< \brief (EIC_INTENSET) MASK Register */
...
#define EIC_INTFLAG_EXTINT_Msk      (_U(0xFF) << EIC_INTFLAG_EXTINT_Pos)
#define EIC_INTFLAG_EXTINT(value)   (EIC_INTFLAG_EXTINT_Msk & ((value) << EIC_INTFLAG_EXTINT_Pos))
#define EIC_INTFLAG_MASK            _U(0x000000FF) /**< \brief (EIC_INTFLAG) MASK Register */
...
#define EIC_WAKEUP_WAKEUPEN_Msk     (_U(0xFF) << EIC_WAKEUP_WAKEUPEN_Pos)
#define EIC_WAKEUP_WAKEUPEN(value)  (EIC_WAKEUP_WAKEUPEN_Msk & ((value) << EIC_WAKEUP_WAKEUPEN_Pos))
#define EIC_WAKEUP_MASK             _U(0x000000FF) /**< \brief (EIC_WAKEUP) MASK Register */
