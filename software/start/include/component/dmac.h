...
#define DMAC_SWTRIGCTRL_SWTRIG_Msk  (_U(0x3F) << DMAC_SWTRIGCTRL_SWTRIG_Pos)
#define DMAC_SWTRIGCTRL_SWTRIG(value) (DMAC_SWTRIGCTRL_SWTRIG_Msk & ((value) << DMAC_SWTRIGCTRL_SWTRIG_Pos))
#define DMAC_SWTRIGCTRL_MASK        _U(0x0000003F) /**< \brief (DMAC_SWTRIGCTRL) MASK Register */
...
#define DMAC_PRICTRL0_LVLPRI0_Msk   (_U(0x7) << DMAC_PRICTRL0_LVLPRI0_Pos)
...
#define DMAC_PRICTRL0_LVLPRI1_Msk   (_U(0x7) << DMAC_PRICTRL0_LVLPRI1_Pos)
...
#define DMAC_PRICTRL0_LVLPRI2_Msk   (_U(0x7) << DMAC_PRICTRL0_LVLPRI2_Pos)
...
#define DMAC_PRICTRL0_LVLPRI3_Msk   (_U(0x7) << DMAC_PRICTRL0_LVLPRI3_Pos)
...
#define DMAC_PRICTRL0_MASK          _U(0x87878787) /**< \brief (DMAC_PRICTRL0) MASK Register */
...
#define DMAC_INTPEND_ID_Msk         (_U(0x7) << DMAC_INTPEND_ID_Pos)
...
#define DMAC_INTPEND_MASK           _U(0xE707)   /**< \brief (DMAC_INTPEND) MASK Register */
...
#define DMAC_INTSTATUS_CHINT_Msk    (_U(0x3F) << DMAC_INTSTATUS_CHINT_Pos)
#define DMAC_INTSTATUS_CHINT(value) (DMAC_INTSTATUS_CHINT_Msk & ((value) << DMAC_INTSTATUS_CHINT_Pos))
#define DMAC_INTSTATUS_MASK         _U(0x0000003F) /**< \brief (DMAC_INTSTATUS) MASK Register */
...
#define DMAC_BUSYCH_BUSYCH_Msk      (_U(0x3F) << DMAC_BUSYCH_BUSYCH_Pos)
#define DMAC_BUSYCH_BUSYCH(value)   (DMAC_BUSYCH_BUSYCH_Msk & ((value) << DMAC_BUSYCH_BUSYCH_Pos))
#define DMAC_BUSYCH_MASK            _U(0x0000003F) /**< \brief (DMAC_BUSYCH) MASK Register */
...
#define DMAC_PENDCH_PENDCH_Msk      (_U(0x3F) << DMAC_PENDCH_PENDCH_Pos)
#define DMAC_PENDCH_PENDCH(value)   (DMAC_PENDCH_PENDCH_Msk & ((value) << DMAC_PENDCH_PENDCH_Pos))
#define DMAC_PENDCH_MASK            _U(0x0000003F) /**< \brief (DMAC_PENDCH) MASK Register */
...
#define DMAC_CHID_ID_Msk            (_U(0x7) << DMAC_CHID_ID_Pos)
#define DMAC_CHID_ID(value)         (DMAC_CHID_ID_Msk & ((value) << DMAC_CHID_ID_Pos))
#define DMAC_CHID_MASK              _U(0x07)     /**< \brief (DMAC_CHID) MASK Register */
...
#define DMAC_CHCTRLB_TRIGSRC_Msk    (_U(0x1F) << DMAC_CHCTRLB_TRIGSRC_Pos)
...
#define DMAC_CHCTRLB_MASK           _U(0x03C01F7F) /**< \brief (DMAC_CHCTRLB) MASK Register */
