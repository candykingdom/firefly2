...
#include <cassert>
#include <effects/ColorCycleEffect.hpp>
#include <effects/ContrastBumpsEffect.hpp>
#include <effects/DarkEffect.hpp>
#include <effects/DisplayColorPaletteEffect.hpp>
#include <effects/FireEffect.hpp>
#include <effects/FireflyEffect.hpp>
#include <effects/LightningEffect.hpp>
#include <effects/PoliceEffect.hpp>
#include <effects/RainbowBumpsEffect.hpp>
#include <effects/RainbowEffect.hpp>
#include <effects/RorschachEffect.hpp>
#include <effects/SimpleBlinkEffect.hpp>
#include <effects/SparkEffect.hpp>
#include <effects/StopLightEffect.hpp>
#include <effects/SwingingLights.hpp>
